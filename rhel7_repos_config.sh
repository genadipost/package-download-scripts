...
cat > /etc/yum.repos.d/foreman-1.17.repo <<END \

[foreman-1.17]
name=Foreman 1.17
baseurl=http://yum.theforeman.org/releases/1.17/el7/\$basearch
enabled=1
gpgcheck=0

END

cat > /etc/yum.repos.d/foreman-plugins-1.17.repo <<END \

[foreman-plugins-1.17]
name=Foreman plugins 1.17
baseurl=http://yum.theforeman.org/plugins/1.17/el7/\$basearch
enabled=1
gpgcheck=0

END

cat > /etc/yum.repos.d/foreman-1.18.repo <<END \

[foreman-1.18]
name=Foreman 1.18
baseurl=http://yum.theforeman.org/releases/1.18/el7/\$basearch
enabled=1
gpgcheck=0

END

cat > /etc/yum.repos.d/foreman-plugins-1.18.repo <<END \

[foreman-plugins-1.18]
name=Foreman plugins 1.18
baseurl=http://yum.theforeman.org/plugins/1.18/el7/\$basearch
enabled=1
gpgcheck=0
...
echo '[nodesource-10.x]
name=Node.js 10.x Packages for Enterprise Linux 7 - $basearch
baseurl=https://rpm.nodesource.com/pub_10.x/el/7/x86_64/
enabled=1
gpgcheck=0' | tee /etc/yum.repos.d/nodesource-10.x.repo
...
[gluster-3.13]
name=gluster-3.13
baseurl=https://buildlogs.centos.org/centos/7/storage/x86_64/gluster-3.13/
enabled=1
gpgcheck=0
